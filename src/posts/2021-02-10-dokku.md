...
I've written about Snowflake <Link to="/projects/snowflake">here</Link> before, but here's the TL;DR: It's a service for generating unique, time-ordered, 64-bit ID numbers. It's built with Python and Flask.
