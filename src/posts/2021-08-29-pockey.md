...
*Did you come here looking for LVGL tips? Skip to [here](#sh1107).*

*Looking for source code? Here's my [CircuitPython work](https://github.com/Breq16/pockey) and my [RP2040 SDK work](https://github.com/Breq16/pocketdeck) on GitHub.*
...
I wrote a Seesaw driver in C++, which made writing to NeoPixels was as easy as this:
