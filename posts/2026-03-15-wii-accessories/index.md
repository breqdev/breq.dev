...
<table class="border-collapse font-mono text-sm w-full max-w-xl mx-auto table-fixed">
  ...
  <tbody class="border-2 border-gray-700 [&>tr]:border-b [&>tr]:border-gray-200 dark:[&>tr]:border-gray-700 [&>tr:last-child]:border-b-0 [&>tr>td:first-child]:py-1 [&>tr>td:first-child]:pr-3 [&>tr>td:first-child]:text-xs [&>tr>td:first-child]:text-gray-400 [&>tr>td:not(:first-child)]:py-1 [&>tr>td]:text-center [&>tr>td:not(:first-child)]:bg-gray-50 dark:[&>tr>td:not(:first-child)]:bg-gray-800">
    <tr>
      <td>0x00</td>
