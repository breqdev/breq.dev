...
![](./first-disk/MVC-004F.JPG)

![](./first-disk/MVC-007F.JPG)
...
![](./first-disk/MVC-009S.JPG)

![](./first-disk/MVC-010S.JPG)

</div>
<div class="grid grid-cols-1 sm:grid-cols-[63fr_112fr] gap-2 max-w-3xl mx-auto my-2">

![](./first-disk/MVC-012S.JPG)

![](./first-disk/MVC-011S.JPG)

</div>
<div class="grid grid-cols-1 sm:grid-cols-[112fr_63fr] gap-2 max-w-3xl mx-auto my-2">

![](./first-disk/MVC-016S.JPG)

![](./first-disk/MVC-015S.JPG)

</div>
<div class="grid grid-cols-1 sm:grid-cols-[63fr_112fr] gap-2 max-w-3xl mx-auto my-2">

![](./first-disk/MVC-023S.JPG)

![](./first-disk/MVC-018S.JPG)

</div>
<div class="grid grid-cols-1 sm:grid-cols-[112fr_63fr] gap-2 max-w-3xl mx-auto my-2">

![](./first-disk/MVC-022F.JPG)

![](./first-disk/MVC-024S.JPG)
