...
![A screenshot of the app's interface, showing a map and a list of transit lines.](./screenshot.jpg)
...
![A screenshot of Burp Suite's proxy settings showing the stated configuration](./burp.png)
